...
void main() {
  final ScreenOnFlutterPlatform initialPlatform =
      ScreenOnFlutterPlatform.instance;

  test('$ChannelScreenOnFlutter is the default instance', () {
    expect(initialPlatform, isInstanceOf<ChannelScreenOnFlutter>());
  });
